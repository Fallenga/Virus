...
public class Baium extends AbstractNpcAI
{
	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		if (zone.isCharacterInZone(killer))
		{
			...
			if (Config.STATIC_RESPAWN_ENABLED && (Config.BAIUM_RESPAWN_DATE != null))
			{
				final long staticRespawn = GrandBossManager.getInstance().getRespawnTime(Config.BAIUM_RESPAWN_DATE);
				if (staticRespawn > 0)
				{
