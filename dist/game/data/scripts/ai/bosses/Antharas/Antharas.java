	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		if (zone.isCharacterInZone(killer))
		{
			if (npc.getId() == ANTHARAS)
			{
				...
				if (Config.STATIC_RESPAWN_ENABLED && (Config.ANTHARAS_RESPAWN_DATE != null))
				{
					final long staticRespawn = GrandBossManager.getInstance().getRespawnTime(Config.ANTHARAS_RESPAWN_DATE);
					if (staticRespawn > 0)
					{
