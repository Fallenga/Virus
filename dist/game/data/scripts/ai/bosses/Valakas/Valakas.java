...
public class Valakas extends AbstractNpcAI
{
	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		...
		if (Config.STATIC_RESPAWN_ENABLED && (Config.VALAKAS_RESPAWN_DATE != null))
		{
			final long staticRespawn = GrandBossManager.getInstance().getRespawnTime(Config.VALAKAS_RESPAWN_DATE);
			if (staticRespawn > 0)
			{
