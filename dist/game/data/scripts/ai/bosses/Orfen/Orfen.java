...
public class Orfen extends AbstractNpcAI
{
	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		if (npc.getId() == ORFEN)
		{
			...
			if (Config.STATIC_RESPAWN_ENABLED && (Config.ORFEN_RESPAWN_DATE != null))
			{
				final long staticRespawn = GrandBossManager.getInstance().getRespawnTime(Config.ORFEN_RESPAWN_DATE);
				if (staticRespawn > 0)
				{
