 ...
 */
public final class BufferEvent extends Npc
{
	public BufferEvent(NpcTemplate template)
	{
		super(template);
	}
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("fbuff"))
		{
			...
			html.setFile(player, "data/html/mods/Buffer/1000006.htm");
	...
	public String getHtmlPath(int npcId, int value, Player player)
	{
		...
		return "data/html/mods/BufferEvent/" + filename + ".htm";
	}
